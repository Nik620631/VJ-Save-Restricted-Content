...
# Bot token @Botfather
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8847969049:AAEYOq_TO1ZLsDuIcbWeIRQxyhne-4vIpJo")

# Your API ID from my.telegram.org
API_ID = int(os.environ.get("API_ID", "38758155"))

# Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "26a8f71e9eeb2cdbdc50cadb56d86f59")

# Your Owner / Admin Id For Broadcast 
ADMINS = int(os.environ.get("ADMINS", "6321372939"))
...
CHANNEL_ID = os.environ.get("CHANNEL_ID", "1003590141223")
